    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'student'), ('teacher', 'teacher'), ('parent', 'parent'), ('admin', 'admin')], default='student', max_length=15, verbose_name='Роль')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='Date')),
                ('teacher', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='lesson',
        ...
        migrations.AddField(
            model_name='user',
            name='institution',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='edu_sys.institution'),
        ),
        migrations.AddField(
            model_name='user',
            name='lesson',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='edu_sys.lesson'),
        ),
        migrations.AddField(
            model_name='user',
            name='post',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='edu_sys.post'),
        ),
        migrations.AddField(
            model_name='user',
            name='subject',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='edu_sys.subject'),
        ),
        migrations.AddField(
            model_name='user',
